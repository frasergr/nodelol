...
Create and edit the Traefik configuration files, `traefik.toml` and `dynamic_conf.toml`:
...
```shell
cp ./etc/traefik/dynamic_conf.toml.example ./etc/traefik/dynamic_conf.toml
nano ./etc/traefik/dynamic_conf.toml
```
